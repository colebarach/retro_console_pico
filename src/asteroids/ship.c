...
xyPoint_t shipModelIdle[SIZE_SHIP_MODEL_IDLE] =
{
...
xyPoint_t shipModelAccelerating[SIZE_SHIP_MODEL_ACCELERATING] =
{
...
void shipInitialize(ship_t* ship, float positionX, float positionY)
{
    ...
    ship->model = xyRenderShape(ship->modelBuffer, 0, 0x00, 0x00, true);
    shipRender(ship);
}
